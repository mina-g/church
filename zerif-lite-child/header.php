...
<?php endif; 
	...
	/* Video background */
	echo '<video class="zerif_video_background" loop="" autoplay="" preload="auto" controls="true" poster="http://www.abusefein.org.au/themes/a_pixel/img/headerphoto.jpg" muted=""><source src="'.get_stylesheet_directory_uri().'/video/blueskysunflare_480p_mp4.mp4" type="video/mp4"></video>';
